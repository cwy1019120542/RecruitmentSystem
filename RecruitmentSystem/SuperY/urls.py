...
url(r'^applicant_(?P<user_id>\w+)/resume_info_modify/$',views.resume_info_modify,name='resume_info_modify'),
url(r'^applicant_(?P<user_id>\w+)/resume_hope_modify/$',views.resume_hope_modify,name='resume_hope_modify'),
url(r'^applicant_(?P<user_id>\w+)/work_experience/add/$',views.work_experience,name='work_experience'),
url(r'^applicant_(?P<user_id>\w+)/work_experience/(?P<work_experience_id>\w+)/$',views.work_experience,name='work_experience'),
