...
class Resume(models.Model):
	...
	birth_place=models.CharField(max_length=255,help_text='出生地')
	experience=models.CharField(max_length=255,help_text='工作经验')
	phone_number=models.CharField(max_length=255,help_text='手机号')
	mail=models.CharField(max_length=255,help_text='邮箱')
	apply_status=models.CharField(max_length=255,help_text='求职状态')
	profession=models.CharField(max_length=255,help_text='期望行业')
	work_place=models.CharField(max_length=255,help_text='期望工作地点')
	post_name=models.CharField(max_length=255,help_text='期望职位')
	salary=models.CharField(max_length=255,help_text='期望薪资')
	work_nature=models.CharField(max_length=255,help_text='工作性质')
